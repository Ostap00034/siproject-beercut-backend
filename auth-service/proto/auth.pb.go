...
type RegisterUserRequest struct {
	...
	// Значение role должно соответствовать одному из:
	// DIRECTOR, ADMIN, RESTORER, EMPLOYEE.
...
var file_proto_auth_proto_depIdxs = []int32{
	...
	4, // 2: auth.AuthService.CreateToken:input_type -> auth.CreateTokenRequest
	6, // 3: auth.AuthService.ValidateToken:input_type -> auth.ValidateTokenRequest
	8, // 4: auth.AuthService.DeleteToken:input_type -> auth.DeleteTokenRequest
	...
	5, // 7: auth.AuthService.CreateToken:output_type -> auth.CreateTokenResponse
	7, // 8: auth.AuthService.ValidateToken:output_type -> auth.ValidateTokenResponse
	9, // 9: auth.AuthService.DeleteToken:output_type -> auth.DeleteTokenResponse
