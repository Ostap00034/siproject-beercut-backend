...
const file_proto_error_proto_rawDesc = "" +
	"\n" +
	"\x11proto/error.proto\x12\x04auth\"\x9d\x01\n" +
	...
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01BIZGgithub.com/Ostap00034/siproject-beercut-backend/auth-service/proto;authb\x06proto3"
...
var file_proto_error_proto_goTypes = []any{
	...
	nil,                   // 1: auth.ErrorResponse.ErrorsEntry
}
var file_proto_error_proto_depIdxs = []int32{
	1, // 0: auth.ErrorResponse.errors:type_name -> auth.ErrorResponse.ErrorsEntry
