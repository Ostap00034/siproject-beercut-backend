...
func (gu *GenreUpdate) SetDescription(s string) *GenreUpdate {
	gu.mutation.SetDescription(s)
	return gu
}

// SetNillableDescription sets the "description" field if the given value is not nil.
func (gu *GenreUpdate) SetNillableDescription(s *string) *GenreUpdate {
	if s != nil {
		gu.SetDescription(*s)
	}
	return gu
...
// SetDescription sets the "description" field.
func (guo *GenreUpdateOne) SetDescription(s string) *GenreUpdateOne {
	guo.mutation.SetDescription(s)
	return guo
}

// SetNillableDescription sets the "description" field if the given value is not nil.
func (guo *GenreUpdateOne) SetNillableDescription(s *string) *GenreUpdateOne {
	if s != nil {
