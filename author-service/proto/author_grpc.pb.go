...
const (
	...
	AuthorService_GetAll_FullMethodName       = "/author.AuthorService/GetAll"
...
func (c *authorServiceClient) GetAll(ctx context.Context, in *GetAllRequest, opts ...grpc.CallOption) (*GetAllResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetAllResponse)
	err := c.cc.Invoke(ctx, AuthorService_GetAll_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAuthorServiceServer) GetAll(context.Context, *GetAllRequest) (*GetAllResponse, error) {
